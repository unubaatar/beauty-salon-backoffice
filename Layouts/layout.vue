<template>
  <v-layout>
    ...
    >
      ...
      <div>
        <div>
        <img style="width: 48px; height: 48px;" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIIWju1ABYrb5DTkZ8mbDcaAekrgKnjmf0CA&s" alt="">
    </div>
    ...
    <div style="color: white;">
        <div v-for="category in sideBarMenuItems">
            ...
            <div  v-for="item in category.items" class="pa-2 sideBarItem" style="cursor: pointer; border-radius: 4px;" >
